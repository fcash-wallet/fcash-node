...
var fcashnode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = fcashnode.version;
  var create = fcashnode.scaffold.create;
  var add = fcashnode.scaffold.add;
  var start = fcashnode.scaffold.start;
  var remove = fcashnode.scaffold.remove;
  var callMethod = fcashnode.scaffold.callMethod;
  var findConfig = fcashnode.scaffold.findConfig;
  var defaultConfig = fcashnode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with Fcash Node configuration')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `fcash-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ fcash-node add wallet-service');
      console.log('    $ fcash-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ fcash-node remove wallet-service');
      console.log('    $ fcash-node remove insight-api');
      console.log();
    });
