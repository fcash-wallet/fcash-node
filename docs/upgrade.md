...
## From Fcash 3.0.0 to 4.0.0

`fcash-node@2.1.1` to `fcash-node@3.0.0`
...
**Important**: Once changes have been made you'll also need to add the `reindex=1` option **only for the first startup** to regenerate the indexes. Once this is complete you should be able to remove the `fcash-node.db` directory with the old indexes.
